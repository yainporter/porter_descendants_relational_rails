...
RSpec.describe "Missions Index Page", type: :feature do
  before(:each) do
    ...
    @spain = @rusty.missions.create(mission_name:"Madrid Spain", mission_language: "Spanish", country: "Spain", members_baptized: 11, foreign_mission: false)
  end
  describe "When I visit '/missions/:id'" do
    it "Will show the mission with that ID, including it's attributes" do
      ...
      expect(page).to have_content(@spain.foreign_mission?)
    end
